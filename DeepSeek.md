...
![（a）我们提出了一种细粒度量化方法，以减轻由特征异常值引起的量化误差；为简化说明，仅展示了前向传播（Fprop）过程。（b）结合我们的量化策略，我们通过每隔$N_{C}=128$个元素的矩阵乘法累加（MMA）操作，将中间结果提升至CUDA核心进行高精度累加，以此提高FP8通用矩阵乘法（GEMM）的精度。](https://github.com/Damon-Chang/Embodied-Intelligence-Note/blob/main/figures/%E6%88%AA%E5%B1%8F2025-02-14%2009.17.44.png)
